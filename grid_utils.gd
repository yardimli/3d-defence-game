...
# NEW: Extracted grid position calculation
...
# NEW: Extracted shadow configuration
...
# NEW: Extracted top Y calculation for stacking
...
# NEW: Extracted stack recalculation logic
