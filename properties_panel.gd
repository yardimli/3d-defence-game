...
# --- Node-Referenzen ---
@onready var grid_pos_label: Label = get_node("MarginContainer/VBoxContainer/HBoxContainer/GridPosLabel")
@onready var pos_x_spinbox: SpinBox = get_node("MarginContainer/VBoxContainer/PosGrid/PosXSpinBox")
@onready var pos_y_spinbox: SpinBox = get_node("MarginContainer/VBoxContainer/PosGrid/PosYSpinBox")
@onready var pos_z_spinbox: SpinBox = get_node("MarginContainer/VBoxContainer/PosGrid/PosZSpinBox")
@onready var scale_spinbox: SpinBox = get_node("MarginContainer/VBoxContainer/HBoxContainer2/ScaleSpinBox")
@onready var order_up_button: Button = get_node("MarginContainer/VBoxContainer/HBoxContainer3/OrderUpButton")
@onready var order_down_button: Button = get_node("MarginContainer/VBoxContainer/HBoxContainer3/OrderDownButton")

func _ready():
	# MODIFIED: Connect signals to specific handlers instead of a generic one.
...
# NEW: Specific handler for any of the position SpinBox values changing.
...
# NEW: Specific handler for the scale SpinBox value changing.
